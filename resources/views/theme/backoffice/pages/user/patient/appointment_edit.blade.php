...
<li><a  href="{{route('patient.appointments', $user)}}">{{'Citas de '. $user->name}}</a></li>
<li><a class="active" >Editar Citas</a></li>
@endsection
		...
		<div id="basic-form" class="section">
			<div class="col s12 m8">
				<div class="card">
					...
					'route' => route('patient.appointments.update',[$user,$appointment]),
